                ...
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;padding:20px;text-align:center;">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width:150px;">
                                                                                    <img height="auto"
                                                                                        src="{{ asset('https://exms.sci.psu.ac.th/image/Brand.png') }}"
                            ...
                            <div
                                style="background:#FC868E;background-color:#FC868E;margin:0px auto;border-radius:4px;max-width:560px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="background:#FC868E;background-color:#FC868E;width:100%;border-radius:4px;">
                                    <tbody>
                                        <tr>
                                            <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                            ...
                            <div
                                style="background:#eb984e;background-color:#eb984e;margin:0px auto;border-radius:4px;max-width:560px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    role="presentation"
                                    style="background:#eb984e;background-color:#eb984e;width:100%;border-radius:4px;">
                                    <tbody>
                                        <tr>
                                            <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                                                @if ($details['jobStatus'] == 'InProcess')
                                                    <div class="mj-column-per-100 mj-outlook-group-fix"
                                                        style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            role="presentation" style="vertical-align:top;"
                                                                ...
                                                                <tr>
                                                                    <td align="left"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            ชื่อเรื่อง:
                                                                            {{ $details['title'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                        ...
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            ไฟล์:
                                                                            @foreach ($filenames as $filenames_item)
                                                                                <br>
                                                                                <a href="{{ url('uploads/'.$filenames_item) }}" target="_blank">{{ $filenames_item }}</a>
                                                                            @endforeach</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            หน่วยงานที่เกี่ยวข้อง:
                                                                            {{ $details['department'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            งานบริการที่ร้องขอ:
                                                                            {{ $details['service'] }}</h2>
                                                                        <h2
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            วันที่: {{ $details['schedule_from'] }}
                                                                            ถึงวันที่: {{ $details['schedule_to'] }}</h2>
                                                                        <h2 class="date"
                                                                            style="margin: 0 0 5px 0; margin-bottom: 5px; font-size: 16px;">
                                                                            ผู้ขอใช้บริการ:
                                                                            {{ $details['to'] }}</h2>
                            ...
                            <div
                                style="background:#52be80;background-color:#52be80;margin:0px auto;border-radius:4px;max-width:560px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    role="presentation"
                                    style="background:#52be80;background-color:#52be80;width:100%;border-radius:4px;">
                                    <tbody>
                                        <tr>
                                            <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                            ...
                            <div
                                style="background:#f7dc6f;background-color:#f7dc6f;margin:0px auto;border-radius:4px;max-width:560px;">
                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                    role="presentation"
                                    style="background:#f7dc6f;background-color:#f7dc6f;width:100%;border-radius:4px;">
                                    <tbody>
                                        <tr>
                                            <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                                                @if ($details['jobStatus'] == 'Received')
                                                    <div class="mj-column-per-100 mj-outlook-group-fix"
                                                        style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            role="presentation" style="vertical-align:top;"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin: 0 0 5px 0;">{{ $details['workgroup'] }}</p>
                                                    <p style="margin: 0 0 5px 0;">{{ $details['faucultySci'] }}</p> ©
                                                    2020
                                                </div>
                                            </td>
                                        </tr>
